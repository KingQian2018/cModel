...
namespace QCM
{
    ...
    static const PaperSize_s A2Paper = {.type = A2, .width = 4200, .height = 5940};
    static const PaperSize_s A3Paper = {.type = A3, .width = 2970, .height = 4200};
    static const PaperSize_s A4Paper = {.type = A4, .width = 2100, .height = 2970};
